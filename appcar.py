...
#Car icon by Icons8
carimg=Image.open('images/icons8-car-30.png')
...
df_database = pd.read_csv("data/top5regs.csv")
df_fuels=pd.read_csv("data/Fuels.csv")
df_carsreg=pd.read_csv("data/CarRegs.csv")
df_cars=pd.read_csv("data/CarsUsedData.csv")
df_predictor=pd.read_csv("data/carpredictor.csv")
...
if nav=="Used Cars Data Analysis":
    ...
    with st.expander("Show Most Popular Car Models"):
        ...
        with g1:
            ...
            st.image("images/msswift.png")

        with g2:
            st.markdown("**Maruti Suzuki Baleno**")
            st.image("images/msbaleno.jpg")
        with h1:
            st.markdown("**Maruti Suzuki Vitara Brezza**")
            st.image("images/msvitarabrezza.jpg")
        with h2:
            st.markdown("**Maruti Suzuki Dzire**")
            st.image("images/msdzire.png")
